...
// NOTE - DllRegisterServer and DllUnregisterServer are omitted from the .def file, please see the
// C++ Package Reference Sample for an example of implementing these functions to support
// registration via regsrv32.exe.